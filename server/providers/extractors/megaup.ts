...
export class MegaUp extends VideoExtractor {
  ...
  constructor(protected override proxyConfig?: ProxyConfig, protected override adapter?: AxiosAdapter) {
  ...
  DecodeIframeData = async (n: string): Promise<{
    url: string
