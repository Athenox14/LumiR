export default {
  ...
  adminLibrary: {
    ...
    embeddings: 'Embeddings de Synopsis',
    embeddingsDesc: 'Vectoriser les synopsis avec multilingual-e5-small (int8) pour enrichir les recommandations sémantiques.',
    embedNew: 'Embedder les nouveaux',
    embedAll: 'Tout re-embedder',
    embedding: 'Embedding en cours…',
    embedLoadingModel: 'Chargement du modèle ONNX (premier lancement : ~90 Mo)…',
    films: 'films',
    filmsPerSec: 'films/s',
    embedCompleted: '{count} synopsis embarqués avec succès.',
    embedCancelled: 'Annulé après {processed} / {total} films.',
    embedFailed: 'Échec de l\'embedding.',
  },
  ...
  adminSettings: {
    ...
    groqHelpTitle: 'Pourquoi Groq ?',
    groqHelpBody: "Groq sert uniquement quand l'extraction classique n'arrive pas à déduire un titre fiable à partir du nom de fichier et des métadonnées. La clé API active ce fallback IA pour améliorer l'identification automatique.",
    groqModel: 'Modèle Groq',
    groqModelDesc: "Choisit le modèle utilisé pour ce fallback IA. La valeur par défaut reprend le modèle actuellement utilisé par l'application.",
    ...
    analyticsEditRawProfile: 'Éditer brut',
    analyticsResetProfile: 'Réinitialiser',
    analyticsRawEditorTitle: 'Profil brut : {user}',
    analyticsRawScores: 'Scores (DB)',
    analyticsRawProfileData: 'Profile data (DB)',
    analyticsScoresObjectRequired: 'Les scores doivent être un objet JSON.',
    analyticsProfileObjectRequired: 'Le profile data doit être un objet JSON.',
    analyticsScoresNumbersOnly: 'Toutes les valeurs de scores doivent être numériques.',
    analyticsProfileSaved: 'Profil analytique enregistré.',
    analyticsProfileSaveError: 'Impossible d’enregistrer le profil analytique.',
    analyticsResetConfirm: 'Réinitialiser ce profil analytique et supprimer ses événements ?',
    analyticsResetSuccess: 'Profil analytique réinitialisé.',
    analyticsResetError: 'Impossible de réinitialiser le profil analytique.',
